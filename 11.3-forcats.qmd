...
Para exemplificar o uso da função `cut()` vamos usar o dataset `mpg` e criar uma variável categórica `cty_cat` a partir `cty` (milhas percorridas na cidade com 1 galão de combustível). A variável `cty` é numérica, com valores variando de 9 milhas a 35 milhas. Vamos definir 3 categorias de carros:
