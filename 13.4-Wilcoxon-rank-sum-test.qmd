...
Nem sempre os dados numéricos seguem um padrão normal. Nesses casos a comparação das médias não pode ser feita com o teste t. Existem vários testes para uso nesses casos, chamados de testes não paramétricos. O teste Wilcoxon rank sum test (Mann-Whitney test) é o equivalente não paramétrico do teste t.
...
Veja como realizar o Wilcoxon rank sum test no R, para amostras independentes, tomando como exemplo os mesmos dados usados no teste t realizado anteriormente.
