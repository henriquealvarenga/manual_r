...
1.  **dados**, argumentos para calcular o que se pretented;
2.  **controles**, argumentos controlam outros aspectos da funcão, por exemplo como lidar com dados faltantes.
...
```{r RStudio-4Panels, echo=FALSE, out.width='100%', fig.show='hold', fig.cap='argumentos da função.'}
