...
Podemos indicar ao R que diretório da sessão de trabalho seja o diretório aberto na aba Files. Para isso:
...
Para criar um projeto (project) clique em `Project` (na parte superior à direita do RStudio) e em seguida em `New Project`.
...
**Vídeo de Criação de Projetos no RStudio** <https://youtu.be/YYRb_7yJSlQ>
...
-   **Resultados**: resultados das análises, gráficos e tabelas, criadas pelos seus scripts.
