...
```{r SetingWorkingDirecory, echo=FALSE, fig.show='hold', fig.cap='Criando um Projeto'}
...
```{r SetingWorkingDirecory2, echo=FALSE, fig.show='hold', fig.cap='Criando um Projeto'}
...
```{r SetingWorkingDirecory3, echo=FALSE, fig.show='hold', fig.cap='Estrutura de Diretórios de um Projeto'}
