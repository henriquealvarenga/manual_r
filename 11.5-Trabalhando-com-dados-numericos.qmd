...
Como os valores dessa `am` variável são números (`0` e `1`), o R os interpreta como numéricos. O mesmo acontece nas variáveis `cyl`, `vs`, `gear` e `carb`, que na verdade são categóricas. A tabela abaixo descreve as variáveis desse conjunto de dados.
