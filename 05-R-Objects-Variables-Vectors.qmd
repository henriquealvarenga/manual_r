...
No exemplo acima vimos um novo operador `:` (dois pontos), que cria uma sequencia de números. No capítulo sobre operadores do R (@sec-operators) iremos discutir melhor o que são operadores e quais os operadores do R.
